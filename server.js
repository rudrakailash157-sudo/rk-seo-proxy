...
const MUKHI_FACTS = {
  1:  { deity: "Lord Shiva (Paramshiva)", planet: "Sun (Surya)", chakra: "Sahasrara (Crown Chakra)", mantra: "Om Hreem Namah" },
  2:  { deity: "Ardhanarishvara (Shiva and Shakti united)", planet: "Moon (Chandra)", chakra: "Swadhisthana (Sacral Chakra)", mantra: "Om Namah" },
  ...
  5:  { deity: "Kalagni Rudra (a form of Lord Shiva)", planet: "Jupiter (Brihaspati)", chakra: "Vishuddha (Throat Chakra)", mantra: "Om Hreem Namah" },
  6:  { deity: "Lord Kartikeya — Shrimad Devibhagwat and Nirnaya Sindhu term it \"Guhasangyak\"; the Jabalopanishad assigns it jointly to Kartikeya and Ganesha; also invokes Goddess Mahalakshmi and Goddess Parvati", planet: "Venus (Shukra) — governs luxury, comfort, and material happiness", chakra: "Muladhara (Root Chakra)", mantra: "Om Hreem Hoom Namah" },
  7:  { deity: "Goddess Mahalakshmi, together with the Sapta Matrikas (Brahmi, Maheshwari, Kaumari, Vaishnavi, Varahi, Indrani, Chamunda) and the Sapta Rishi (Marichi, Atri, Angira, Pulatsya, Pulaha, Kratu, Vashishtha) per the Jabalopanishad", planet: "Saturn (Shani)", chakra: "Hrit Padma (Sacred Heart Chakra)", mantra: "Om Hoom Namah" },
  8:  { deity: "Lord Ganesha", planet: "Rahu", chakra: "Muladhara (Root Chakra)", mantra: "Om Hoom Namah" },
  9:  { deity: "Goddess Durga — the nine forms of Navadurga (Shailaputri, Brahmacharini, Chandraghanta, Kushmanda, Skandamata, Katyayani, Kaalaratri, Mahagauri, Siddhidatri); also Bhairava (Shiva) per the Padma Purana and Shrimad Devibhagwat", planet: "Ketu", chakra: "Sahasrara (Crown Chakra)", mantra: "Om Hreem Hoom Namah" },
  ...
  11: { deity: "Ekadasha Rudras (the eleven forms of Lord Shiva); Lord Hanuman", planet: "Mars (Mangal)", chakra: "Vishuddha (Throat Chakra)", mantra: "Om Hreem Hoom Namah" },
  12: { deity: "Surya Deva (the Sun God)", planet: "Sun (Surya)", chakra: "Manipura (Solar Plexus Chakra)", mantra: "Om Kraum Sraum Raum Namah" },
  13: { deity: "Kamadeva and Lord Indra", planet: "Venus (Shukra)", chakra: "Swadhisthana (Sacral Chakra)", mantra: "Om Hreem Namah" },
  14: { deity: "Maha Rudra (Lord Shiva); Lord Hanuman", planet: "Saturn (Shani)", chakra: "Muladhara (Root Chakra)", mantra: "Om Namah" },
};

// Extracts the mukhi number from a product title (e.g. "7 Mukhi Rudraksha..." -> 7)
// and returns its verified facts, or null if no table entry exists (e.g. 15-21
// Mukhi, Gauri Shankar, or other combination beads not yet in the table).
...
async function runSEOPipeline(product) {
  ...
  const mukhiFactsBlock = mukhiFacts
    ? `VERIFIED MUKHI FACTS (mandatory — use these exact facts for deity, planet, chakra, and mantra; do not invent alternates, do not substitute a different deity/planet/chakra, do not omit the scripture references given):\nRuling Deity: ${mukhiFacts.deity}\nRuling Planet: ${mukhiFacts.planet}\nAssociated Chakra: ${mukhiFacts.chakra}\nBeej Mantra: ${mukhiFacts.mantra}\n`
    : `No verified facts table entry exists for this specific bead (e.g. it may be a 15-21 Mukhi, Gauri Shankar, or other combination bead). Use only widely-corroborated, mainstream Vedic Rudraksha tradition sources for deity/planet/chakra/mantra — do not invent specifics you cannot support, and prefer omitting a detail over guessing one.\n`;
